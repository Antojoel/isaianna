                ...
                for i in persons:
                    if abs(cx-i.getX()) <= w and abs(cy-i.getY()) <= h:
                        ...
                        if i.going_UP(line_down,line_up) == True:
                            ...
                            id = str(id)
                            times = str(times)
                            data = id +' crossed going in at '+times
                            # data = str(data)
                            firebase.put('/data', "up" ,data)
                            # firebase.post('/peoplecounter-ae29f-default-rtdb/log',data)
                            print (data)
                            ...
                            id = str(id)
                            times = str(times)
                            data = id+' crossed going out at '+times
                            # data = str(data)
                            firebase.put('/data',"down",data)
                            # firebase.post('/peoplecounter-ae29f-default-rtdb/log',data)
                            print (data)
                        break
                    if i.getState() == '1':
